...
parser.add_argument('--dataset_path', type=str, default='/content/drive/My Drive/ColabNotebooks/DeepCovid-master/data/',
...
if __name__ == "__main__":
    ...
    model_conv.eval()
    torch.save(model_conv, '/content/drive/My Drive/ColabNotebooks/DeepCovid-master/ResNet18/covid_resnet18_epoch%d.pt' %args.epochs )
